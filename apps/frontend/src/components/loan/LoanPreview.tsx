    ...
    return (
      <div className="space-y-6">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground">Analyzing your loan data...</p>
        </div>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <p className="text-sm">
                  {loanDetails.term} {loanDetails.termUnit}
                </p>
              ...
              <div className="space-y-4">
                {enhanced.recommendedInterestRate !== undefined && (
                  <div>
                    ...
                    <p className="text-sm">
                      {enhanced.recommendedInterestRate}%
                    </p>
                    {enhanced.recommendedInterestRate >
                    loanDetails.interestRate ? (
                      <p className="text-xs text-muted-foreground mt-1">
                        Higher than your proposed rate (
                        {loanDetails.interestRate}%)
                      </p>
                    ) : (
                      <p className="text-xs text-muted-foreground mt-1">
                        Lower than your proposed rate (
                        {loanDetails.interestRate}%)
                      </p>
                    )}
                  </div>
